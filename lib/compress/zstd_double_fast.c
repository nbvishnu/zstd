...
_search_next_long:
        {   size_t const hl3 = ZSTD_hashPtr(ip+1, hBitsL, 8);
            ...
            U32 const dictMatchIndexAndTagL3 = dictHashLong[dictHashAndTagL3 >> ZSTD_DFAST_TAG_BITS];
            size_t const dictTagsMatchL3 = (dictMatchIndexAndTagL3 & ZSTD_DFAST_TAG_MASK) == (dictHashAndTagL3 & ZSTD_DFAST_TAG_MASK);
            ...
            if (matchIndexL3 > prefixLowestIndex) {
                ...
                U32 const dictMatchIndexL3 = dictMatchIndexAndTagL3 >> ZSTD_DFAST_TAG_BITS;
